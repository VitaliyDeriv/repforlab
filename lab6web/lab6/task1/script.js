...
document.addEventListener('DOMContentLoaded', () => {
    if (goods.length === 0) {
        const hint = getElementById('hint-text')
...
function AddProduct() {
    ...
    if (!name || !category || !price || !imageInput) {
    ...
    modalContainer.innerHTML = `
        ...
        <div class="modal-edit">
            ...
            <form id="add-product-form">
                ...
                <label>Image URL:
                    <input id="add-image" type="text" required>
                </label>
                <div class="button-wrapper">
                    <button class="btn" type="button" onclick="hideAddProductModal()">Close</button>
                    <button class="btn" type="submit" onclick="AddProduct()">Add</button>
                </div>
            </form>
        </div>
    `;
...
function showEditProductModal(product) {
    ...
    modal.innerHTML = `
        ...
        <form>
            ...
            <label>Image URL:
                <input id="modal-image" type="text"">
            </label>
            <div class="button-wrapper">
